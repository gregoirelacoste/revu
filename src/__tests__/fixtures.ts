...
export function defaultScoringConfig(): ScoringConfig {
  return {
    ...
    lineCriticality: {
      security: 2.5, signature: 2.0, errorHandling: 1.5, database: 1.5,
      controlFlow: 1.2, injection: 1.2, async: 1.1, dataTransform: 0.9,
      returnLogic: 1.0, assignment: 0.8, declaration: 0.6, typeDecl: 0.4,
      logging: 0.3, import: 0.2, comment: 0.1, whitespace: 0.0,
    },
  };
}
